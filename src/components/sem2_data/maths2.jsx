...
function Maths2() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter only Semester 1 Maths 2 materials
        const filteredMaterials = data.duMaterials?.filter(
          (item) => item.sem === "1" && (item.subject.toLowerCase() === "maths2" ||item.subject === "Mathematics - II" )
        ) || [];
  ...
  return (
    <div className="main-container">
      <Navbar />
      <h1 className="text-center text-3xl font-bold text-gray-800 my-6">Maths 2 - Semester 1</h1>
