...
function Oat() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter only Semester 2 OAT materials
        const filteredMaterials = data.duMaterials?.filter(
          (item) => item.sem === "2" && (item.subject.toLowerCase() === "oat" ||item.subject === "Office Automation Tools" )
        ) || [];
  ...
  return (
    <div className="main-container">
      <h1 className="text-center text-3xl font-bold text-gray-800 my-6">OAT - Semester 2</h1>
