...
function Phy2() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter only Semester 1 Physics materials
        const filteredMaterials = data.duMaterials?.filter(
          (item) => item.sem === "2" && (item.subject.toLowerCase() === "phy2" ||item.subject=== "Physics" )
        ) || [];
  ...
  return (
    <div className="main-container">
      <h1 className="text-center text-3xl font-bold text-gray-800 my-6">Physics - Semester 2</h1>
